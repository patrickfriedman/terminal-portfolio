    ...
    switch (section) {
      ...
      case "projects":
        return [
          ...
          "   • Built an HTML parser to extract and process training data from 50 articles",
          "   • Increased training performance by 36% using word frequency analysis",
          "   Technologies: Python",
          "",
          "2. Nemmeth Braille to Text Translator",
          "   • Developed an Android app to scan Nemmeth Braille (8-dot for Math) and convert it to text",
          "   • Led as Project Manager, setting benchmarks and managing tasks",
          "   • Built image processing library using Python with OpenCV",
          "   • Designed intuitive GUI for user-friendly interaction",
          ...
          "   • Configured VMware EXSi, Hyper-V, AWS, and integrated Azure for multi-cloud environments",
          "   • Led solution integration and testing, optimizing network subnetting",
          "   • Utilized Active Directory, DHCP, Domain Controllers, and PFsense",
          "",
      ...
      case "github":
        return [
          ...
          "",
          "5. workloadsecurityapi",
          "   • Retrieves information through the Workload Security API and formats it into a CSV file.",
          "   • github.com/patrickfriedman/workloadsecurityapi",
          "",
          "6. Python2SMS",
          "   • Uses Twilio to send SMS messages.",
          "   • github.com/patrickfriedman/Python2SMS",
          "",
          "7. Bootstrap-Website",
          "   • Bootstrap-based website resume.",
          "   • github.com/patrickfriedman/Bootstrap-Website",
          "",
          "8. Restaurant-Kiosk",
          ...
          "",
          "9. Linux-Shell",
          "   • Fully functional shell/command line interpreter with interactive and batch modes.",
          "   • github.com/patrickfriedman/Linux-Shell",
          "",
          "10. Sudoku-Solver",
          ...
          "",
          "11. CiteSite",
          "    • Automated multi-source citation generator.",
          "    • github.com/patrickfriedman/CiteSite",
          "",
          "12. Library-Management-System",
          "    • Library system for adding, searching, and managing check-ins/check-outs.",
          "    • github.com/patrickfriedman/Library-Management-System",
          "",
          "13. Connect4",
          "    • Classic Connect Four game.",
          "    • github.com/patrickfriedman/Connect4",
          "",
          "14. Gradebook",
          "    • Fully functional gradebook for managing courses, students, and grades.",
          "    • github.com/patrickfriedman/Gradebook",
          "",
          "15. Airport-Management-System",
          "    • Manages flights, crew information, and airplanes in real-time.",
          "    • github.com/patrickfriedman/Airport-Management-System",
          "",
          "16. Thesaurus-Text-Replacer",
          "    • Replaces words in a text file using a thesaurus and a given number of hops.",
          "    • github.com/patrickfriedman/Thesaurus-Text-Replacer",
          "",
          "17. STEPS-EMS",
          "    • Emergency system to call authorities and provide necessary information.",
          "    • github.com/patrickfriedman/STEPS-EMS",
          "",
      ...
      default:
        if (currentDirectory.includes("projects/1")) {
          return [
            "=== Classification of Subjective and Objective Texts Using RNN ===",
            "",
            "A machine learning project developed during a 24-hour competition that classifies",
            "text as either objective or subjective using Recurrent Neural Networks.",
            "",
            "Key Achievements:",
            "• Led team as Product Manager, assigning tasks and ensuring on-time completion",
            "• Developed an HTML parser that extracted training data from 50 articles in 3 minutes",
            "• Implemented data preprocessing techniques that improved model accuracy",
            "• Optimized training performance by 36% through word frequency analysis",
            "",
            "Technologies: Python, RNN, Natural Language Processing",
            "",
          ...
          return [
            "=== Nemmeth Braille to Text Translator ===",
            "",
            "An Android application that uses computer vision to scan Nemmeth Braille",
            "(specialized 8-dot system for mathematical notation) and convert it to readable text in real-time.",
            "",
            "Key Achievements:",
            "• Led project as Project Manager, setting benchmarks and resolving technical challenges",
            "• Developed image processing algorithms using Python and OpenCV",
            "• Created pattern recognition system for accurate Braille dot detection",
            "• Designed intuitive user interface for seamless scanning experience",
            "",
            "Technologies: Python, Java, Kotlin, OpenCV, Android SDK",
            "",
            "Type 'cd ..' to go back to projects",
            "",
          ]
