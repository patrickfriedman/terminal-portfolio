    ...
    switch (section) {
      ...
      case "github":
        return [
          ...
          "Recent Projects:",
          "",
          "1. Classification-RNN",
          "   • Machine learning project for text classification",
          "   • Python, TensorFlow, Natural Language Processing",
          "   • github.com/patrickfriedman/Classification-RNN",
          "",
          "2. Braille-Translator",
          "   • Android app for translating Nemmeth Braille to text",
          "   • Kotlin, Java, Python, OpenCV",
          "   • github.com/patrickfriedman/Braille-Translator",
          "",
          "3. Security-Lab-Infrastructure",
          "   • Scripts and configurations for security testing environments",
          "   • PowerShell, Bash, Terraform",
          "   • github.com/patrickfriedman/Security-Lab-Infrastructure",
          "",
        ...
        switch (target) {
          ...
          case "1":
            if (currentDirectory === "~/projects") {
              ...
              return ["Changed directory to projects/1"]
            } else {
          ...
          case "2":
            if (currentDirectory === "~/projects") {
              ...
              return ["Changed directory to projects/2"]
            } else {
              return [`cd: invalid path: ${target} - must be in projects directory`]
            }
          ...
          case "3":
            if (currentDirectory === "~/projects") {
              ...
              return ["Changed directory to projects/3"]
            } else {
              return [`cd: invalid path: ${target} - must be in projects directory`]
            }
